...
export const GUIA_II_QUESTIONS: GuiaIIQuestion[] = [
  { id: "guia_ii_1", questionnaireCode: "GUIA_II", questionNumber: 1, text: "Mi trabajo me exige hacer mucho esfuerzo físico", responseType: "likert", order: 1 },
  ...
  { id: "guia_ii_7", questionnaireCode: "GUIA_II", questionNumber: 7, text: "Mi trabajo exige que esté muy concentrado", responseType: "likert", order: 7 },
  { id: "guia_ii_8", questionnaireCode: "GUIA_II", questionNumber: 8, text: "Mi trabajo requiere que memorice mucha información", responseType: "likert", order: 8 },
  ...
  { id: "guia_ii_11", questionnaireCode: "GUIA_II", questionNumber: 11, text: "Respondo ante mi jefe por los resultados de toda mi área de trabajo", responseType: "likert", order: 11 },
  { id: "guia_ii_12", questionnaireCode: "GUIA_II", questionNumber: 12, text: "En mi trabajo me dan órdenes contradictorias", responseType: "likert", order: 12 },
  ...
  { id: "guia_ii_14", questionnaireCode: "GUIA_II", questionNumber: 14, text: "Trabajo horas extras más de tres veces a la semana", responseType: "likert", order: 14 },
  { id: "guia_ii_15", questionnaireCode: "GUIA_II", questionNumber: 15, text: "Mi trabajo me exige laborar en días de descanso, festivos o fines de semana", responseType: "likert", order: 15 },
  ...
  { id: "guia_ii_23", questionnaireCode: "GUIA_II", questionNumber: 23, text: "Me informan con claridad cuáles son mis funciones", responseType: "likert", order: 23 },
  ...
  { id: "guia_ii_25", questionnaireCode: "GUIA_II", questionNumber: 25, text: "Me informan con quién puedo resolver problemas o asuntos de trabajo", responseType: "likert", order: 25 },
  ...
  { id: "guia_ii_27", questionnaireCode: "GUIA_II", questionNumber: 27, text: "Recibo capacitación útil para hacer mi trabajo", responseType: "likert", order: 27 },
  ...
  { id: "guia_ii_30", questionnaireCode: "GUIA_II", questionNumber: 30, text: "Puedo confiar en mis compañeros de trabajo", responseType: "likert", order: 30 },
  { id: "guia_ii_31", questionnaireCode: "GUIA_II", questionNumber: 31, text: "Cuando tenemos que realizar trabajo de equipo los compañeros colaboran", responseType: "likert", order: 31 },
  { id: "guia_ii_32", questionnaireCode: "GUIA_II", questionNumber: 32, text: "Mis compañeros de trabajo me ayudan cuando tengo dificultades", responseType: "likert", order: 32 },
  ...
  { id: "guia_ii_34", questionnaireCode: "GUIA_II", questionNumber: 34, text: "Recibo críticas constantes a mi persona y/o trabajo", responseType: "likert", order: 34 },
  ...
  { id: "guia_ii_38", questionnaireCode: "GUIA_II", questionNumber: 38, text: "Se ignoran mis éxitos laborales y se atribuyen a otros trabajadores", responseType: "likert", order: 38 },
  ...
  { id: "guia_ii_43", questionnaireCode: "GUIA_II", questionNumber: 43, text: "Para hacer mi trabajo debo demostrar sentimientos distintos a los míos", responseType: "likert", order: 43 },
