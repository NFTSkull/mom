...
export default function Home() {
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col items-start justify-center gap-6 px-4 py-10">
      <h1 className="text-3xl font-semibold text-zinc-900">Portal Interno NOM-035 (MVP local)</h1>
      <p className="max-w-2xl text-zinc-700">
        Base local para validar flujo, pantallas y calculo preliminar sin Supabase ni autenticacion.
      </p>
